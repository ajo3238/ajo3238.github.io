...
import capstone.code.validators.ValidDeletePart;
...
public abstract class Part implements Serializable {
    ...
    @GetMapping("isInvBelowMin")
    public boolean isInvBelowMin()
    {
        if(inv < minInv)
        {
            return true;
    ...
    @GetMapping("/isInvAboveMax")
    public boolean isInvAboveMax()
    {
        if(inv > maxInv)
        {
            return true;
